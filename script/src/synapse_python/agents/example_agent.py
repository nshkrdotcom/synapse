...
# # # synapse_python/src/synapse_python/agents/example_agent.py
# # from pydantic import BaseModel
...
#     # result_type=Output,
#     system_prompt=""" 
# "You are a helpful assistant that responds in JSON format. You are running within an agent process in the Synapse framework.",
# """,
#     temperature=0.0
# )
