defmodule AxonCore.ErrorTest do
  use ExUnit.Case
  alias AxonCore.Error
  alias AxonCore.Error.{PythonEnvError, AgentError, HTTPError, ToolError}
  ...
  describe "error formatting" do
    ...
    test "includes stacktrace when requested", %{error: error} do
      ...
      assert formatted =~ "test/axon_core/error_test.exs"
    end
