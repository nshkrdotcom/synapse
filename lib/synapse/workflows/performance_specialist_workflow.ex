defmodule Synapse.Workflows.PerformanceSpecialistWorkflow do
  @moduledoc """
  Executes the performance specialist checks via `Synapse.Workflow.Engine`,
  providing consistent telemetry and optional persistence.
  """
  ...
  defp spec do
    ...
    Spec.new(
      name: :performance_specialist_workflow,
      description: "Sequential performance analysis (complexity/memory/profile)",
      metadata: %{version: 1},
      steps: steps,
      outputs: []
    )
  ...
  defmodule StepRunner do
    ...
    use Jido.Action,
      name: "performance_step_runner",
      description: "Runs a performance specialist action",
      schema: [
