# defmodule SynapseCore.AgentProcessTest do
#   use ExUnit.Case, async: true

#   alias SynapseCore.AgentProcess
...
#       HTTPClientMock = defmock("Elixir.SynapseCore.HTTPClient", for: HTTPClient)
...
# test/synapse_core/agent_process_test.exs
...
#     HTTPoisonMock = defmock("SynapseCore.HTTPClient", for: HTTPClient)
...
#     HTTPClientMock = defmock("SynapseCore.HTTPClient", for: HTTPClient)
...
# synapse_core/test/synapse_core/agent_process_test.exs
...
defmodule SynapseCore.AgentProcessTest do
  ...
  # Mock HTTPClient for testing purposes
  def setup(_) do
    HTTPClientMock = defmock("SynapseCore.HTTPClientMock", for: HTTPClient)
